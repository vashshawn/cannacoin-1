...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 7143 or testnet: 17143)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7142 or testnet: 17142)") + "\n" +
        ...
        "\n" + _("SSL options: (see wiki.cannacoin.com for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (pwalletMain)
        GenerateCannacoins(GetBoolArg("-staking", true), pwalletMain);
